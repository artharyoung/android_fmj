package com.artharyoung.game.fmj.lib;


import android.content.Context;

import com.artharyoung.game.fmj.characters.Monster;
import com.artharyoung.game.fmj.characters.NPC;
import com.artharyoung.game.fmj.characters.Player;
import com.artharyoung.game.fmj.characters.ResLevelupChain;
import com.artharyoung.game.fmj.characters.SceneObj;
import com.artharyoung.game.fmj.goods.BaseGoods;
import com.artharyoung.game.fmj.goods.GoodsDecorations;
import com.artharyoung.game.fmj.goods.GoodsDrama;
...
import com.artharyoung.game.fmj.goods.GoodsMedicineChg4Ever;
import com.artharyoung.game.fmj.goods.GoodsMedicineLife;
import com.artharyoung.game.fmj.goods.GoodsStimulant;
import com.artharyoung.game.fmj.goods.GoodsTudun;
import com.artharyoung.game.fmj.goods.GoodsWeapon;
import com.artharyoung.game.fmj.magic.MagicAttack;
import com.artharyoung.game.fmj.magic.MagicAuxiliary;
import com.artharyoung.game.fmj.magic.MagicEnhance;
import com.artharyoung.game.fmj.magic.MagicRestore;
import com.artharyoung.game.fmj.magic.MagicSpecial;
import com.artharyoung.game.fmj.magic.ResMagicChain;
...
public final class DatLib {
	...
	private DatLib(Context context) throws IOException {
		InputStream in = null;
		try {
//			in = new FileInputStream(new File("file:///android_asset/"+FILE_NAME));

			in = context.getAssets().open("DAT.LIB");
