package com.artharyoung.game.fmj.combat.ui;
...
import com.artharyoung.game.fmj.combat.actions.Action;
import com.artharyoung.game.fmj.combat.actions.ActionCoopMagic;
import com.artharyoung.game.fmj.combat.actions.ActionDefend;
import com.artharyoung.game.fmj.combat.actions.ActionMagicAttackAll;
import com.artharyoung.game.fmj.combat.actions.ActionMagicAttackOne;
import com.artharyoung.game.fmj.combat.actions.ActionMagicHelpAll;
import com.artharyoung.game.fmj.combat.actions.ActionMagicHelpOne;
import com.artharyoung.game.fmj.combat.actions.ActionPhysicalAttackAll;
import com.artharyoung.game.fmj.combat.actions.ActionPhysicalAttackOne;
import com.artharyoung.game.fmj.combat.actions.ActionThrowItemAll;
import com.artharyoung.game.fmj.combat.actions.ActionThrowItemOne;
import com.artharyoung.game.fmj.combat.actions.ActionUseItemAll;
import com.artharyoung.game.fmj.combat.actions.ActionUseItemOne;
import com.artharyoung.game.fmj.combat.anim.FrameAnimation;
import com.artharyoung.game.fmj.gamemenu.ScreenChgEquipment;
import com.artharyoung.game.fmj.gamemenu.ScreenGoodsList;
import com.artharyoung.game.fmj.gamemenu.ScreenGoodsList.Mode;
import com.artharyoung.game.fmj.goods.BaseGoods;
import com.artharyoung.game.fmj.goods.GoodsEquipment;
import com.artharyoung.game.fmj.goods.GoodsHiddenWeapon;
...
import com.artharyoung.game.fmj.magic.MagicSpecial;
import com.artharyoung.game.fmj.magic.ScreenMagic;
...
public class CombatUI extends BaseScreen {
	...
	private class MenuGoods extends BaseScreen {
									...
									if (goods.effectAll()) {
										...
										CombatUI.this.mScreenStack.push(new MenuCharacterSelect(mMonsterIndicator, sMonsterIndicatorPos, mMonsterList,
												new OnCharacterSelectedListener() {
													...
													public void onCharacterSelected(FightingCharacter fc) {
														// add throw action
														onActionSelected(new ActionThrowItemOne(mPlayerList.get(mCurPlayerIndex), fc, (GoodsHiddenWeapon)goods));
													}
												}, true));
									}
								}
		...
		private List<BaseGoods> getThrowableGoodsList() {
			...
			/**
			 * 武器与暗器继承自一个基类，但不能互相转型。先屏蔽掉武器的投掷
			 */
			// 可投掷武器
