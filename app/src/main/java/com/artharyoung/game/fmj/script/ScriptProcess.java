package com.artharyoung.game.fmj.script;
...
import com.artharyoung.game.fmj.characters.Direction;
import com.artharyoung.game.fmj.characters.NPC;
import com.artharyoung.game.fmj.characters.Player;
import com.artharyoung.game.fmj.combat.Combat;
...
import com.artharyoung.game.fmj.lib.ResBase;
import com.artharyoung.game.fmj.lib.ResGut;
...
//			System.out.println("cmd_facetoface");
		...
		public Operate getOperate(final byte[] code, final int start) {
			return new OperateDrawOnce() {
				...
				private com.artharyoung.game.fmj.characters.Character getCharacter(int id) {
					if (id == 0) {
				...
				@Override
				public boolean process() {
					com.artharyoung.game.fmj.characters.Character c1 = getCharacter(get2ByteInt(code, start));
					com.artharyoung.game.fmj.characters.Character c2 = getCharacter(get2ByteInt(code, start + 2));
