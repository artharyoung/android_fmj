...
import com.artharyoung.game.fmj.gamemenu.ScreenGoodsList.OnItemSelectedListener;
	...
	public void onKeyUp(int key) {
		if (key == Global.KEY_CANCEL) {
			...
			GameView.getInstance().pushScreen(new ScreenGoodsList(mSelId == 0 ?
					Player.sGoodsList.getGoodsList() : Player.sGoodsList.getEquipList(), this, ScreenGoodsList.Mode.Use));
		}
	}
